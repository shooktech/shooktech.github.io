...
define("../vendor/almond-custom", function(){});
...
define('main',['require','durandal/app','durandal/viewLocator','durandal/system','fastclick','bootstrap'],function(require) {
...
define('viewmodels/vm_base',['require','uberproto'],function(require) {
...
define('viewmodels/about',['require','plugins/router','durandal/app','./vm_base'],function(require) {
...
define('viewmodels/careers',['require','plugins/router','durandal/app','./vm_base'],function(require) {
    var router = require('plugins/router');
    var app = require('durandal/app');
...
define('viewmodels/footer',['require','plugins/router','durandal/app','./vm_base'],function(require) {
    var router = require('plugins/router');
    var app = require('durandal/app');
...
define('viewmodels/home',['require','durandal/app','knockout','plugins/router','./vm_base'],function(require) {
	var app = require('durandal/app'),
		ko = require('knockout'),
...
define('viewmodels/shell',['require','plugins/router','durandal/app','./vm_base'],function(require) {
    var router = require('plugins/router');
    var app = require('durandal/app');
...
define('text!views/about.html',[],function () { return '<section class="row" id="about">\r\n\t<div class="col-lg-8 col-lg-offset-2">\r\n\t\t<div class="col-sm-12">\r\n\t\t\t<h1 id="message">Gadgets, fashion, entertainment, cats<span>-Just Kidding, for now...-</span>, and collectibles</h1>\r\n\t\t</div>\r\n\r\n\t\t<div class="col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3">\r\n\t\t\t<p class="statement">\r\n\t\t\tWe are a group of innovative young professionals who  \r\n\t\t\tunwittingly established the Detroit Packing Co. while studying at MSU back in 2012 when we were selling Linksys routers out of our dorm. After graduation-no, we didn\'t drop out like the cool kids-we decided that we wanted to change the world. So we moved to the only logical place to do that, the best place to change the world economically and socially from. We moved to The Bay. The DPC isn\'t just some startup full of craft beer drinking, slacklining millennials with nothing palpable to contribute. We actually do, and mean, business!\r\n\r\n\t\t\t<br>\r\n\t\t\t<br>\r\n\r\n\t\t\tOur website currently doesn\'t offer e-commerce but will soon! We are building the store as we speak, line by line of code. In the meantime you can securely  shop with us through our\r\n\t\t\t<a href="http://www.amazon.com/gp/aag/main?ie=UTF8&asin=&seller=A13ZDU6VPG0TGQ" target="_blank">Amazon</a> and <a href="https://squareup.com/market/detroit-packing-co" target="_blank">Square</a> \r\n\t\t\tstorefronts. Make sure to leave feedback, whether it be good or bad; we want to \r\n\t\t\tlearn from you.\r\n\r\n\t\t\t<br>\r\n\t\t\t<br>\r\n\r\n\t\t\tIf you need a job and live around the Bay Area, then click <a href="http://sfbay.craigslist.org/search/jjj" target="_blank">here</a>.\r\n\r\n\t\t\t<br>\r\n\t\t\t<br>\r\n\r\n\t\t\tBecause we don\'t have time for people who need jobs, we\'re looking for people who <span class="emphasis">want</span> them!\r\n\t\t\t If this sounds like you then you might make a good \r\n\t\t\t<a href="#careers">addition to our team.</a>\r\n\t\t\t</p>\r\n\t\t</div>\r\n\t</div>\r\n</section>\r\n\r\n<footer data-bind="compose: \'viewmodels/footer\'"></footer>';});

define('text!views/careers.html',[],function () { return '<section class="row" id="careers">\r\n\t<div class="row">\r\n\t\t<div class="col-lg-8 col-lg-offset-2">\r\n\t\t\t<div class="col-sm-4">\r\n\t\t\t\t<h2>DESTINATION:</h2>\r\n\t\t\t</div>\r\n\r\n\t\t\t<div class="col-sm-8">\r\n\t\t\t\t<h2 id="redwoodcity">\r\n\t\t\t\t\t<span style="color:red;">RED</span>WOOD CITY\r\n\t\t\t\t</h2>\r\n\t\t\t</div>\r\n\r\n\t\t\t<div class="row">\r\n\t\t\t\t<div class="col-sm-4">\r\n\t\t\t\t\t<blockquote>"Climate Best By Government Test"</blockquote>\r\n\t\t\t\t</div>\r\n\r\n\t\t\t\t<div class="col-sm-8">\r\n\t\t\t\t\t<p class="statement">\r\n\t\t\t\t\t\tWant to live at the heart of the heart of The Bay?\r\n\t\t\t\t\t\tWe have the best climate according to government tests! \r\n\t\t\t\t\t\tWhy would you live and work anywhere else?\r\n\r\n\t\t\t\t\t\t<br>\r\n\t\t\t\t\t\t<br>\r\n\r\n\t\t\t\t\t\tWe love our employees and they love us. It\'s not uncommon for \r\n\t\t\t\t\t\tour team to discuss philosophy while kicking back a couple craft beers. Of \r\n\t\t\t\t\t\tcourse after satisfying our customers.\r\n\t\t\t\t\t\t<br>\r\n\t\t\t\t\t\t<br>\r\n\r\n\t\t\t\t\t\tWe offer competitive salaries and generous benefits. We prefer to \r\n\t\t\t\t\t\thire locals. No remote work please!\r\n\t\t\t\t\t</p>\r\n\t\t\t\t</div>\r\n\t\t\t</div>\r\n\t\t</div>\r\n\t</div>\r\n\r\n\t<div class="row banner-jobs">\r\n\t\t<div class="col-lg-8 col-lg-offset-2">\r\n\t\t\t<div class="col-sm-4">\r\n\t\t\t\t<h5>We love</h5>\r\n\t\t\t</div>\r\n\t\t\t<div class="col-sm-8">\r\n\t\t\t\t<ul>\r\n\t\t\t\t\t<li>Culture</li>\r\n\t\t\t\t\t<li>Craft Beer</li>\r\n\t\t\t\t\t<li>Ping Pong</li>\r\n\t\t\t\t\t<li>Foosball</li>\r\n\t\t\t\t\t<li>Cats</li>\r\n\t\t\t\t\t<li>Marketing Savvy</li>\r\n\t\t\t\t\t<li>Innovation</li>\r\n\t\t\t\t\t<li>C, C++, or Java</li>\r\n\t\t\t\t\t<li>Adobe Creative Suite</li>\r\n\t\t\t\t</ul>\r\n\t\t\t</div>\r\n\t\t</div>\r\n\t</div>\r\n\r\n\t<div class="row">\r\n\t\t<div class="col-lg-8 col-lg-offset-2">\r\n\t\t\t<div class="col-sm-4">\r\n\t\t\t\t<h5>Currently looking for:</h5>\r\n\t\t\t</div>\r\n\r\n\t\t\t<div class="col-sm-8">\r\n\t\t\t\t<h5>Sorry. We currently have no openings. Check again soon!</h5>\r\n\t\t\t</div>\r\n\t\t</div>\r\n\t</div>\r\n</section>\r\n\r\n<footer data-bind="compose: \'viewmodels/footer\'"></footer>';});

define('text!views/footer.html',[],function () { return '<section class="row" id="footer">\r\n        <img class="col-xs-12 col-sm-2" src="./images/white.png" />\r\n\r\n        <div class="col-sm-8">\r\n            <div class="col-md-3" id="contact">\r\n                <a href="mailto:info@detroitpacking.co">\r\n                    <i class="fa fa-envelope"></i> info@detroitpacking.co\r\n                </a>\r\n                <a href="tel:0000000000">\r\n                    <br><i class="fa fa-phone"></i> 000.000.0000\r\n                </a>\r\n            </div>\r\n            \r\n            <ul id="site-map" data-bind="foreach: router.routes">\r\n                    <li data-bind="css: { active: isActive }">\r\n                        <a data-bind="attr: { href: hash }, text: title"></a>\r\n                    </li>\r\n            </ul>\r\n        </div>\r\n</section>';});

define('text!views/home.html',[],function () { return '<div id="carousel-example-generic" class="carousel slide col-xs-12" data-ride="carousel">\r\n    <!-- Indicators -->\r\n    <ol class="carousel-indicators" data-bind="foreach: carouselItems">\r\n      <li data-bind="attr: {\'data-target\': \'#carousel-example-generic\',\r\n                            \'data-slide-to\': $index}">\r\n      </li>\r\n    </ol>\r\n\r\n    <!-- Wrapper for slides -->\r\n    <div class="carousel-inner" role="listbox">\r\n      <!-- ko foreach: carouselItems -->\r\n      <div class="item" data-bind="css: { active: $index() == 0 }">\r\n        <img data-bind="attr {src: img}" alt="...description">\r\n        <div class="carousel-caption" data-bind="text: caption"></div>\r\n      </div>\r\n      <!-- /ko -->\r\n    </div>\r\n\r\n    <!-- Controls -->\r\n    <a class="left carousel-control" href="#carousel-example-generic" role="button" data-slide="prev">\r\n      <span class="glyphicon glyphicon-chevron-left" aria-hidden="true"></span>\r\n      <span class="sr-only">Previous</span>\r\n    </a>\r\n    <a class="right carousel-control" href="#carousel-example-generic" role="button" data-slide="next">\r\n      <span class="glyphicon glyphicon-chevron-right" aria-hidden="true"></span>\r\n      <span class="sr-only">Next</span>\r\n    </a>\r\n</div>\r\n\r\n<section class="row" id="banner-statement">\r\n  <div class="col-md-8 col-md-offset-2">\r\n    <h1 class="text-right">\r\n      DETROIT quality service\r\n    </h1>\r\n    <h2 class="text-right">\r\n      Anywhere in the WORLD*\r\n    </h2>\r\n    <h3 class="text-right">\r\n      Based in the BAY AREA\r\n    </h3>\r\n  </div>\r\n</section>\r\n\r\n<section class="row">\r\n  <div class="col-lg-8 col-lg-offset-2">\r\n    <div class="col-sm-4 facade-mission text-center">\r\n      <h3 class=\'\'>What we do</h3>\r\n      <i class="fa fa-shopping-cart fa-4x"></i>\r\n      <p>We purvey quality products in tech, fashion, and niche collectibles</p>\r\n    </div>\r\n    <div class="col-sm-4 facade-mission text-center">\r\n      <h3 class=\'\'>Detroit Quality</h3>\r\n      <i class="fa fa-thumbs-up fa-4x"></i>\r\n      <p>Established in Detroit, we know quality when it comes to products and service</p>\r\n    </div>\r\n    <div class="col-sm-4 facade-mission text-center">\r\n      <h3 class="">Bay Area Friendliness</h3>\r\n      <i class="fa fa-heart fa-4x"></i>\r\n      <p>Bringing you politically correct service and opinions which have \r\n        diversity and sustainability in mind</p>\r\n    </div>\r\n  </div>\r\n</section>\r\n\r\n<section class="row">\r\n  <div class="col-lg-8 col-lg-offset-2">\r\n    <div class="col-sm-4">\r\n      Image here\r\n    </div>\r\n\r\n    <div class="col-sm-8">\r\n      <h2 class="header-primary">People love us</h2>\r\n      <p class="statement">\r\n        With a proven track record, people are satisifed with our service. Just \r\n        read our customer feedback. Others were happy with our speedy and friendly \r\n        service and we are sure that you will love us, too!\r\n      </p>\r\n    </div>\r\n  </div>\r\n</section>\r\n\r\n<footer data-bind="compose: \'viewmodels/footer\'"></footer>\r\n';});

define('text!views/shell.html',[],function () { return '<div class="container-fluid">\r\n    <nav class="navbar navbar-default navbar-fixed-top" id="main-nav" role="navigation">\r\n        <div class="col-xs-12 col-lg-8 col-lg-offset-2">\r\n            <div class="navbar-header">\r\n                <button type="button" id= "navbar-toggle" class="navbar-toggle" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1">\r\n                    <span class="sr-only">Toggle Navigation</span>\r\n                    <span class="icon-bar"></span>\r\n                    <span class="icon-bar"></span>\r\n                    <span class="icon-bar"></span>\r\n                </button>\r\n                <a class="navbar-brand" href="#">\r\n                    <span id="logo">detroit</span>\r\n                </a>\r\n            </div>\r\n\r\n            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">\r\n                <ul class="nav navbar-nav" data-bind="foreach: router.navigationModel">\r\n                    <li data-bind="css: { active: isActive }">\r\n                        <a data-bind="attr: { href: hash }, text: title, click: $root.navClick"></a>\r\n                    </li>\r\n                </ul>\r\n\r\n                <ul class="nav navbar-nav navbar-right">\r\n                    <li>\r\n                        <a href="http://www.amazon.com/gp/aag/main?ie=UTF8&asin=&seller=A13ZDU6VPG0TGQ" target="_blank">\r\n                          <strong>Amazon</strong> \r\n                        </a>\r\n                    </li>\r\n                    <li>\r\n                        <a href="https://squareup.com/market/detroit-packing-co"\r\n                            target="_blank">\r\n                            <strong>Square</strong>\r\n                        </a>\r\n                    </li>\r\n                    <!--\r\n                    <li class="loader" data-bind="css: { active: router.isNavigating }">\r\n                        <i class="fa fa-spinner fa-spin fa-2x"></i>\r\n                    </li>\r\n                -->\r\n                </ul>\r\n            </div>\r\n        </div>\r\n    </nav>\r\n\r\n    <div class="page-host" data-bind="router: { transition:\'entrance\' }"></div>\r\n\r\n</div>';});

define('text!views/welcome.html',[],function () { return '<section>\r\n\r\n  <div id="carousel-example-generic" class="carousel slide col-md-12" data-ride="carousel">\r\n    <!-- Indicators -->\r\n    <ol class="carousel-indicators">\r\n      <li data-target="#carousel-example-generic" data-slide-to="0" class="active"></li>\r\n      <li data-target="#carousel-example-generic" data-slide-to="1"></li>\r\n      <li data-target="#carousel-example-generic" data-slide-to="2"></li>\r\n    </ol>\r\n\r\n    <!-- Wrapper for slides -->\r\n    <div class="carousel-inner" role="listbox">\r\n      <div class="item active">\r\n        <img src="http://johnrichardthompson.com/images/photographs/mackinac.jpg" alt="...">\r\n        <div class="carousel-caption">\r\n          ...\r\n        </div>\r\n      </div>\r\n      <div class="item">\r\n        <img src="http://johnrichardthompson.com/images/photographs/camcorder.jpg" alt="...">\r\n        <div class="carousel-caption">\r\n          ...\r\n        </div>\r\n      </div>\r\n      ...\r\n    </div>\r\n\r\n    <!-- Controls -->\r\n    <a class="left carousel-control" href="#carousel-example-generic" role="button" data-slide="prev">\r\n      <span class="glyphicon glyphicon-chevron-left" aria-hidden="true"></span>\r\n      <span class="sr-only">Previous</span>\r\n    </a>\r\n    <a class="right carousel-control" href="#carousel-example-generic" role="button" data-slide="next">\r\n      <span class="glyphicon glyphicon-chevron-right" aria-hidden="true"></span>\r\n      <span class="sr-only">Next</span>\r\n    </a>\r\n  </div>\r\n\r\n  <div class="col-md-8 col-md-offset-2">\r\n    Generic WEbsite for the best company ever made! Detroit PAcking Company!\r\n    Based in the Bay Area, but called the Detroit PAcking Company!!\r\n    Generic WEbsite for the best company ever made! Detroit PAcking Company!\r\n    Based in the Bay Area, but called the Detroit PAcking Company!!\r\n  </div>\r\n    \r\n</section>';});
